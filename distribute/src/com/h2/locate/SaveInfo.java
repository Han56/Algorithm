...
public class SaveInfo {
	...
	/**
	 * 计算能量通用函数，这里我们将去掉台站中的最大能量和最小能量，求平均值。
	 * @param sensors1
	 * @return
	 * @author Hanlin Zhang.
	...
	public double calEnergy() {
		...
		//get the max energy and min energy in array.
		double maxDouble = one_dim_array_max_min.maxdouble(energy);
		double minDouble = one_dim_array_max_min.mindouble(energy);
		
		//set the final energy with the minumum value of all sensors.
		finalEnergy = (sumEnergy - maxDouble - minDouble) / (energy.length - 2);
